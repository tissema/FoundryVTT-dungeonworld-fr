 ...
 * Correctif graphique: Position des Webcams (dungeonworld.css)
 * Correctif de la bande sonore originale Kult Divinité Perdue (dungeonworld-ost.db)
 ...
 * Mise à jour de transition du système (passage de kult4e à dungeonworld)
 ...
 * Ajout de la bande sonore originale Kult Divinité Perdue (source: https://helmgast.bandcamp.com/album/dungeonworld-original-game-soundtrack)
 ...
 * Graphic correction: Webcams position (dungeonworld.css)
 * Correction of the original soundtrack Kult Divinity Lost (dungeonworld.db)
 ...
 * System transition update (from kult4e to dungeonworld)
 ...
 * Added the original soundtrack Kult Divinity Lost (source: https://helmgast.bandcamp.com/album/dungeonworld-original-game-soundtrack)
 ...
 * Translation of the Actions table (file dungeonworld.moves.json) 
